...
public class Leaf
{
    ...
    /**
     * Method Wither
     * Метод в'янути. Присвоюэм просто листка колір жовтий і виводимо відповідне повідомлення на екран
     */
    void Wither()
    {
    ...
    /**
     * Method GrowUp
     * Метод рости. Коли він викликається ми просто до довжини самого листка додаємо випадкове число від 0 до 10
     */
    void GrowUp()
    {
